...
export const RHYME_TIME_LEVELS: RTLevel[] = [
  ...
  { level: 16, questions: [{ word: "night", choices: ["delight", "grow", "gold", "shine"] }, { word: "spring", choices: ["everything", "night", "grow", "gold"] }, { word: "day", choices: ["holiday", "spring", "night", "grow"] }] },
  ...
  { level: 19, questions: [{ word: "inspire", choices: ["admire", "mountain", "treasure", "thunder"] }, { word: "together", choices: ["whether", "inspire", "mountain", "treasure"] }, { word: "discovery", choices: ["embroidery", "together", "inspire", "mountain"] }] },
